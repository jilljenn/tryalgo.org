...
## [P8 - Treblecross](https://uva.onlinejudge.org/index.php?option=onlinejudge&page=show_problem&problem=1502)
...
This game can be solved using the [Sprague-Grundy](https://fr.wikipedia.org/wiki/Th%C3%A9or%C3%A8me_de_Sprague-Grundy) theorem.
[Here](http://lbv-pc.blogspot.fr/2012/07/treblecross.html) is an excellent explanation of a solution.

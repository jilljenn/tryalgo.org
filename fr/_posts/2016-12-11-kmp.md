...
Les lettres alignées de T et de M dont les cases sont en bleu sont les mêmes en T et en M. Les lettres en position k-1 en T et en M sont différentes : sinon, si elles étaient identiques, on pourrait agrandir le bord d'une lettre de plus.
...
La première lettre que l'on veut rencontrer en cas d'occurrence du motif "peaux" est la lettre p : il en résulte alors que l'on a trouvé un bord de taille maximale 1 (Hé oui, le bord égal à "p". Yeaaaaaah). On passe alors ainsi de l'état 0 à l'état 1. 
